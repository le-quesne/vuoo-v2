...
export const OPTIMIZATION_MODES: OptimizationModeDef[] = [
  {
    ...
    icon: Zap,
    title: 'Eficiencia',
    billingHint: 'Útil si tienes flota propia o pagas por hora/km.',
  ...
  },
  {
    ...
    billingHint: 'Útil si pagas por vuelta/ruta al transportista.',
  ...
  },
  {
    ...
    billingHint: 'Útil si pagas por entrega o quieres que ningún conductor cargue más que otro.',
  ...
  },
  {
    ...
    billingHint: 'Útil si tienes SLA con tus clientes o ventanas horarias estrictas (farmacia, comida, B2B con multa).',
