...
```typescript
// src/application/utils/errorMessages.ts (implementación actual)
...
Aplicar siempre que se renderice al usuario un `res.error` proveniente de un servicio. Está cubierto por `errorMessages.test.ts` (8 casos).
